...
// Cross-tab sync: when another tab changes localStorage (dashboard → public pages)
window.addEventListener('storage', function(e) {
  const keyMap = {
    'hm_produtos':'produtos','hm_servicos':'servicos','hm_clientes':'clientes',
    'hm_parceiros':'parceiros','hm_pedidos':'pedidos','hm_config':'config',
    'hm_blog':'blog','hm_cupoes':'cupoes','hm_banking':'banking'
  };
  if (e.key && keyMap[e.key]) {
    window.dispatchEvent(new CustomEvent('hm_update', {detail: keyMap[e.key]}));
  }
});
